...
namespace UITest {
    public static class GameObjectUtils {
        // Can't use System.Linq
        public static GameObject GetGameObject (this GameObject[] gameObjects, string name) {
        ...
        public static UIButton CreateButton (this GameObject root, Vector3 size, string name, string text,
                List<EventDelegate> onClick, int fontSize, Color color, Font ttf = null) {
